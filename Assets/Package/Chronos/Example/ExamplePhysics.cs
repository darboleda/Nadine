	...
	public class ExamplePhysics : ExampleBaseBehaviour
	{
		...
		void Spawn()
		{
			...
			for (int i = 0; i < amount; i++)
			{
				...
				// Give it a physics timer for physics supprt
				PhysicsTimer3D physics = go.AddComponent<PhysicsTimer3D>();
				// Enable rewinding for 30 seconds at a 5 snapshots/s precision
				physics.SetRecording(30, 0.2f);
